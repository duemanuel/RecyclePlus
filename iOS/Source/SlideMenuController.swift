...
struct SlideMenuOptions {
    ...
    static var leftBezelWidth: CGFloat = 30.0
    ...
    static var animationDuration: CGFloat = 0.5
    static var rightViewWidth: CGFloat = 270.0
    static var rightBezelWidth: CGFloat = 30.0
...
public class SlideMenuController: UIViewController, UIGestureRecognizerDelegate {
    ...
    func initView() {
		...
		mainContainerView.autoresizingMask = UIViewAutoresizing([.FlexibleHeight, .FlexibleWidth])
        ...
        opacityView.autoresizingMask = UIViewAutoresizing([.FlexibleHeight, .FlexibleWidth])
